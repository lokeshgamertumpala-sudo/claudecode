...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
  ...
  // src/components/ui/CircleButton.jsx
  ...
  var CircleButton_default = CircleButton;

  // src/components/ui/TopBar.jsx
  var TopBar = ({ city = "HYDERABAD", onClick, statusLabel }) => {
    return /* @__PURE__ */ import_react2.default.createElement("header", { className: "flex-between w-full px-8 pt-8 pb-8" }, /* @__PURE__ */ import_react2.default.createElement("div", null, /* @__PURE__ */ import_react2.default.createElement("span", { className: "text-xs uppercase tracking-wider text-muted" }, city)), /* @__PURE__ */ import_react2.default.createElement(
      CircleButton_default,
      {
        onClick,
        variant: "primary",
  ...
  var Dock = ({ children, className = "" }) => {
    return /* @__PURE__ */ import_react3.default.createElement("footer", { className: `glass w-full px-8 py-8 ${className}` }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex justify-center gap-8" }, children));
  };
  var Dock_default = Dock;

  // src/components/AppShell.jsx
  var AppShell = () => {
    return /* @__PURE__ */ import_react4.default.createElement("div", { className: "app-shell min-h-screen flex flex-column bg-gradient-to-br from-[var(--background-gradient-start)] to-[var(--background-gradient-end)] text-[var(--text-primary)] font-[var(--font-family)]" }, /* @__PURE__ */ import_react4.default.createElement(TopBar_default, null), /* @__PURE__ */ import_react4.default.createElement("main", { className: "flex-1 w-full px-6" }, /* @__PURE__ */ import_react4.default.createElement(Outlet, null)), /* @__PURE__ */ import_react4.default.createElement(Dock_default, null));
  };
  var AppShell_default = AppShell;

  // src/state/useAlertStore.jsx
  var import_react5 = __toESM(require_react());
  var AlertContext = (0, import_react5.createContext)();
  var AlertProvider = ({ children }) => {
    const [status, setStatus] = (0, import_react5.useState)("allClear");
    return /* @__PURE__ */ import_react5.default.createElement(AlertContext.Provider, { value: { status, setStatus } }, children);
  };
  var useAlertStore = () => {
    const context = (0, import_react5.useContext)(AlertContext);
    if (!context) {
  ...
  var StatusHero = ({ status }) => {
    ...
    return /* @__PURE__ */ import_react6.default.createElement("div", { className: "flex flex-col items-center text-center gap-4" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: `${config.bg} rounded-full p-4` }, /* @__PURE__ */ import_react6.default.createElement("span", { className: "text-4xl" }, config.icon)), /* @__PURE__ */ import_react6.default.createElement("h1", { className: `text-2xl font-weight-semibold ${config.color}` }, config.label), /* @__PURE__ */ import_react6.default.createElement("p", { className: "text-muted max-w-md" }, "Hyderabad is currently ", status === "allClear" ? "safe and calm." : status === "watch" ? "under observation for potential risks." : "experiencing an active alert. Follow safety instructions."));
  };
  var StatusHero_default = StatusHero;

  // src/components/ui/GlassCard.jsx
  var import_react7 = __toESM(require_react());
  var GlassCard = ({ children, className = "", ...props }) => {
    return /* @__PURE__ */ import_react7.default.createElement("div", { className: `glass ${className}`, ...props }, children);
  };
  ...
  var PillButton_default = PillButton;
  ...
  // src/components/AlertOverlay.jsx
  var AlertOverlay = ({ status, onClear }) => {
    const { status: storeStatus } = useAlertStore();
    const [isMuted2, setIsMuted] = (0, import_react9.useState)(false);
    ...
    return /* @__PURE__ */ import_react9.default.createElement("div", { className: "fixed inset-0 z-50 flex items-end justify-center px-4 pb-8" }, /* @__PURE__ */ import_react9.default.createElement("div", { className: "glass-dark rounded-t-2xl w-full max-w-xl p-6 space-y-4 relative" }, /* @__PURE__ */ import_react9.default.createElement("div", { className: "flex justify-between items-start" }, /* @__PURE__ */ import_react9.default.createElement("h2", { className: "text-xl font-weight-semibold text-coral" }, "Flood Warning for Hyderabad"), /* @__PURE__ */ import_react9.default.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ import_react9.default.createElement(
      "button",
      {
        onClick: onClear,
      ...
      isMuted2 ? "\u{1F50A}" : "\u{1F507}"
    ))), /* @__PURE__ */ import_react9.default.createElement("p", { className: "text-muted" }, "SafeNest alert. Flood warning for Hyderabad. Stay inside. Do not walk in water. I can help you call your family or official helpline 1 1 2."), /* @__PURE__ */ import_react9.default.createElement("div", { className: "flex gap-3" }, /* @__PURE__ */ import_react9.default.createElement(
      "button",
      {
  ...
  var AlertOverlay_default = AlertOverlay;

  // src/lib/alertEngine.js
  var demoData = null;
  var loadDemoData = async () => {
    try {
  ...
  var Home = () => {
    ...
    const handleSimulateFlood = () => {
      alertEngine_default.simulateFloodAlert();
      setStatus("alert");
    };
    const handleSimulateHeat = () => {
      alertEngine_default.simulateHeatAlert();
      setStatus("alert");
    };
    const handleAskAI = () => {
    ...
    return /* @__PURE__ */ import_react10.default.createElement(GlassCard_default, { className: "flex min-h-[calc(100%-4rem)] flex-col items-center justify-center p-6 gap-4" }, /* @__PURE__ */ import_react10.default.createElement(StatusHero_default, { status }), /* @__PURE__ */ import_react10.default.createElement("div", { className: "flex flex-wrap gap-4 justify-center" }, /* @__PURE__ */ import_react10.default.createElement(CircleButton_default, { onClick: handleAskAI, variant: "primary", size: "lg" }, /* @__PURE__ */ import_react10.default.createElement("span", { className: "text-xl" }, "\u{1F916}")), /* @__PURE__ */ import_react10.default.createElement(CircleButton_default, { onClick: handleSimulateFlood, variant: "amber", size: "lg" }, /* @__PURE__ */ import_react10.default.createElement("span", { className: "text-xl" }, "\u{1F30A}")), /* @__PURE__ */ import_react10.default.createElement(CircleButton_default, { onClick: handleSimulateHeat, variant: "coral", size: "lg" }, /* @__PURE__ */ import_react10.default.createElement("span", { className: "text-xl" }, "\u{1F525}")), /* @__PURE__ */ import_react10.default.createElement(CircleButton_default, { onClick: handleFamily, variant: "primary", size: "lg" }, /* @__PURE__ */ import_react10.default.createElement("span", { className: "text-xl" }, "\u{1F468}\u200D\u{1F469}\u200D\u{1F467}\u200D\u{1F466}")), /* @__PURE__ */ import_react10.default.createElement(CircleButton_default, { onClick: handleSafetyMode, variant: "primary", size: "lg" }, /* @__PURE__ */ import_react10.default.createElement("span", { className: "text-xl" }, "\u{1F6E1}\uFE0F"))), /* @__PURE__ */ import_react10.default.createElement(AlertOverlay_default, { status, onClear: () => {
      alertEngine_default.setAllClear();
      setStatus("allClear");
    } }));
  };
  ...
  // src/App.jsx
  var UIKit = () => {
    return /* @__PURE__ */ import_react11.default.createElement(GlassCard_default, { className: "w-full max-w-md mx-auto mt-16 p-8" }, /* @__PURE__ */ import_react11.default.createElement("h2", { className: "text-xl font-weight-semibold mb-8" }, "UI Kit Preview"), /* @__PURE__ */ import_react11.default.createElement("div", { className: "flex-column gap-8" }, /* @__PURE__ */ import_react11.default.createElement("div", null, /* @__PURE__ */ import_react11.default.createElement("h3", { className: "font-weight-medium mb-8" }, "GlassCard"), /* @__PURE__ */ import_react11.default.createElement(GlassCard_default, { className: "p-8" }, /* @__PURE__ */ import_react11.default.createElement("p", { className: "text-muted" }, "This is a glass card component."))), /* @__PURE__ */ import_react11.default.createElement("div", null, /* @__PURE__ */ import_react11.default.createElement("h3", { className: "font-weight-medium mb-8" }, "CircleButton"), /* @__PURE__ */ import_react11.default.createElement("div", { className: "flex gap-8" }, /* @__PURE__ */ import_react11.default.createElement(CircleButton_default, { variant: "default", size: "md" }, "Default"), /* @__PURE__ */ import_react11.default.createElement(CircleButton_default, { variant: "primary", size: "md" }, "Primary"), /* @__PURE__ */ import_react11.default.createElement(CircleButton_default, { variant: "amber", size: "md" }, "Amber"), /* @__PURE__ */ import_react11.default.createElement(CircleButton_default, { variant: "coral", size: "md" }, "Coral"))), /* @__PURE__ */ import_react11.default.createElement("div", null, /* @__PURE__ */ import_react11.default.createElement("h3", { className: "font-weight-medium mb-8" }, "PillButton"), /* @__PURE__ */ import_react11.default.createElement("div", { className: "flex flex-wrap gap-8" }, /* @__PURE__ */ import_react11.default.createElement(PillButton_default, { variant: "default", size: "md" }, "Default"), /* @__PURE__ */ import_react11.default.createElement(PillButton_default, { variant: "primary", size: "md" }, "Primary"), /* @__PURE__ */ import_react11.default.createElement(PillButton_default, { variant: "amber", size: "md" }, "Amber"), /* @__PURE__ */ import_react11.default.createElement(PillButton_default, { variant: "coral", size: "md" }, "Coral"))), /* @__PURE__ */ import_react11.default.createElement("div", null, /* @__PURE__ */ import_react11.default.createElement("h3", { className: "font-weight-medium mb-8" }, "TopBar"), /* @__PURE__ */ import_react11.default.createElement(TopBar_default, { onClick: () => alert("Status clicked!"), statusLabel: "Check status" })), /* @__PURE__ */ import_react11.default.createElement("div", null, /* @__PURE__ */ import_react11.default.createElement("h3", { className: "font-weight-medium mb-8" }, "Dock"), /* @__PURE__ */ import_react11.default.createElement(Dock_default, null, /* @__PURE__ */ import_react11.default.createElement(CircleButton_default, { variant: "primary", size: "lg" }, /* @__PURE__ */ import_react11.default.createElement("span", { className: "text-xl" }, "\u2699\uFE0F")), /* @__PURE__ */ import_react11.default.createElement(CircleButton_default, { variant: "amber", size: "lg" }, /* @__PURE__ */ import_react11.default.createElement("span", { className: "text-xl" }, "\u{1F4CA}")), /* @__PURE__ */ import_react11.default.createElement(CircleButton_default, { variant: "coral", size: "lg" }, /* @__PURE__ */ import_react11.default.createElement("span", { className: "text-xl" }, "\u{1F6A8}"))))));
  };
  var App = () => {
    return /* @__PURE__ */ import_react11.default.createElement(AlertProvider, null, /* @__PURE__ */ import_react11.default.createElement(AppShell_default, null, /* @__PURE__ */ import_react11.default.createElement(Routes, null, /* @__PURE__ */ import_react11.default.createElement(Route, { path: "/", element: /* @__PURE__ */ import_react11.default.createElement(Home_default, null) }), /* @__PURE__ */ import_react11.default.createElement(Route, { path: "/dev/ui-kit", element: /* @__PURE__ */ import_react11.default.createElement(UIKit, null) }), /* @__PURE__ */ import_react11.default.createElement(Route, { path: "*", element: /* @__PURE__ */ import_react11.default.createElement("div", { className: "flex flex-col items-center justify-center flex-1 text-center p-8" }, /* @__PURE__ */ import_react11.default.createElement("h2", { className: "text-xl font-semibold" }, "404"), /* @__PURE__ */ import_react11.default.createElement("p", { className: "text-muted" }, "Page not found")) }))));
  };
  var App_default = App;

  // src/main.jsx
  import_client.default.createRoot(document.getElementById("root")).render(
    /* @__PURE__ */ import_react12.default.createElement(import_react12.default.StrictMode, null, /* @__PURE__ */ import_react12.default.createElement(HashRouter, null, /* @__PURE__ */ import_react12.default.createElement(App_default, null)))
  );
})();
